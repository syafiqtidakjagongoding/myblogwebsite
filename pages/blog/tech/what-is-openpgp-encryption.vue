...
useHead({
  ...
  link: [
    {
      rel: 'canonical',
      href: `${config.public.baseUrl}/blog/tech/what-is-openpgp-encryption`,
    },
  ],
  meta: [
    {
      name: 'description',
      content:
        'Privacy isn’t a luxury — it’s a right. OpenPGP gives you the power to protect your messages from snoopers, hackers, and prying eyes. It’s the gold standard for secure communication, trusted by journalists, devs, and privacy advocates worldwide.',
    },
    {
      name: 'keywords',
  ...
  <div>
    ...
    >
      ...
      <h1 class="text-3xl md:text-4xl font-bold text-gray-900 leading-tight mb-4">
        {{ isEnglish ? 'How to communicate using OpenPGP' : 'Cara komunikasi menggunakan OpenPGP' }}
      </h1>
      ...
      <div class="px-2 py-8">
        <div class="max-w-none">
          ...
          <ul class="list-disc list-inside mb-4 space-y-1">
            ...
            <li>
              <strong>Openkeychain</strong> – {{ isEnglish ? 'for Android' : 'untuk Android' }}
            </li>
          ...
          <ul class="list-disc list-inside mb-6 space-y-1">
            ...
            <li>
              {{
                isEnglish
                  ? 'Sharing personal files via cloud'
                  : 'Berbagi file pribadi melalui cloud'
              }}
            </li>
            <li>
              {{ isEnglish ? 'Signing digital documents' : 'Menandatangani dokumen digital' }}
            </li>
            <li>
              {{
                isEnglish
