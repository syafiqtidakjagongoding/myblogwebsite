  ...
  <div>
    ...
    >
      <h1 class="text-3xl md:text-4xl font-bold text-gray-900 leading-tight mb-4">
        {{
          isEnglish
            ? "Beginner's Guide to Fediverse"
            : 'Alternatif Social media yang perlu kamu ketahui'
        }}
      </h1>
      ...
      <div class="px-2 py-8">
        <div class="max-w-none">
          ...
          <h2 class="text-2xl font-semibold mt-8 mb-3 text-gray-900">
            {{
              isEnglish
                ...
                : '🤔 Masalah dengan Media Sosial Tradisional'
            }}
          </h2>
          ...
          <!-- Sharkey/Misskey -->
          <h3 class="text-xl font-medium mt-6 mb-2 text-gray-800">
            {{ isEnglish ? 'Sharkey & Misskey' : 'Sharkey & Misskey' }}
          </h3>
          <div class="relative mb-4">
            <img
          ...
          <!-- GoToSocial -->
          <h3 class="text-xl font-medium mt-6 mb-2 text-gray-800">
            {{ isEnglish ? 'GoToSocial' : 'GoToSocial' }}
          </h3>
          <div class="relative mb-4">
            <img
          ...
          <!-- Section 5: Benefits -->
          <h2 class="text-2xl font-semibold mt-8 mb-3 text-gray-900">
            {{ isEnglish ? 'Benefits' : 'Benefit' }}
          </h2>
          <ul class="list-disc list-inside mb-6 space-y-2 text-gray-700">
            <li
              v-html="
                isEnglish
                  ? '<strong>No Algorithm Manipulation</strong> — You see posts chronologically, not what the algorithm thinks you want to see.'
                  : '<strong>Tidak Ada Manipulasi Algoritma</strong> — Kamu melihat postingan secara kronologis, bukan apa yang algoritma pikirkan yang ingin kamu lihat.'
              "
            ></li>
            <li
              v-html="
                isEnglish
                  ? '<strong>No Data Harvesting</strong> — Your data is not sold to advertisers because there are no advertisers.'
                  : '<strong>Tidak Ada Pengumpulan Data</strong> — Datamu tidak dijual ke pengiklan karena tidak ada pengiklan.'
              "
            ></li>
            <li
              v-html="
                isEnglish
                  ? '<strong>No Shadowbanning</strong> — Your content will not be secretly suppressed because the server owner does not have reason to hide it.'
                  : '<strong>Tidak Ada Shadowbanning</strong> — Kontenmu tidak akan disembunyikan secara diam-diam karena pemilik server tidak punya alasan untuk menyembunyikannya.'
              "
            ></li>
            <li
              v-html="
                isEnglish
                  ? '<strong>You Control Your Data</strong> — You can migrate to another server or even export all your data anytime.'
                  : '<strong>Kamu Mengontrol Data Mu</strong> — Kamu bisa berpindah ke server lain atau mengekspor semua datamu kapan saja.'
              "
            ></li>
            <li
              v-html="
                isEnglish
                  ? '<strong>Censorship-Resistant</strong> — No single company can delete your account or block the entire platform.'
                  : '<strong>Tahan Sensor</strong> — Tidak ada satu perusahaan pun yang bisa menghapus akunmu atau memblokir seluruh platform.'
              "
            ></li>
          </ul>
       </div>
