...
useHead({
  title: 'Why Monero Is Different Than Other Cryptocurrencies',
  link: [
    {
      rel: 'canonical',
      href: `${config.public.baseUrl}/blog/tech/what-is-monero`,
    },
  ],
  meta: [
    {
      name: 'description',
      content:
        'Your bank knows everything. Blockchains? Even worse. Monero breaks the system — no tracking, no exposure, no compromise.',
    },
    {
      name: 'keywords',
  ...
  <div>
    ...
    >
      <h1 class="text-3xl md:text-4xl font-bold text-gray-900 leading-tight mb-4">
        {{
          isEnglish
            ? 'Why Monero Is Different Than Other Cryptocurrencies ?'
            : 'Kenapa Monero Berbeda Dengan Cryptocurrencies Yang Lain ?'
        }}
      </h1>
      ...
      <div class="px-2 py-8">
        <div class="max-w-none">
          ...
          <h2 class="text-2xl font-semibold mt-8 mb-3 text-gray-900">
            {{ isEnglish ?  'Stealth Address' : 'Alamat Stealth' }}
          </h2>
